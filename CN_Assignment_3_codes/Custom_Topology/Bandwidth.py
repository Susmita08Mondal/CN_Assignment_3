...
def main():
    ...
    print(H.cmd('python3 tcp_client.py 1 %s |& tee -a output.log &' %S.IP()))
    print(I.cmd('python3 tcp_client.py 2 %s |& tee -a output.log &' %S.IP()))
    print(J.cmd('python3 tcp_client.py 3 %s |& tee -a output.log &' %S.IP()))
    print(K.cmd('python3 tcp_client.py 4 %s |& tee -a output.log &' %S.IP()))
    sleep(5)
