...
class TreeCustomTopo( Topo ):
    ...
    def build( self ):
        ...
        self.addLink(switches[1],switches[2], cls=TCLink , bw =200)
...
def main():
    ...
    (H.cmd('python3 cp_client.py 1 %s |& tee -a output.log &' %S.IP()))
    (I.cmd('python3 tcp_client.py 2 %s |& tee -a output.log &' %S.IP()))
    (J.cmd('python3 tcp_client.py 3 %s |& tee -a output.log &' %S1.IP()))
    (K.cmd('python3 tcp_client.py 4 %s |& tee -a output.log &' %S2.IP()))
